...
• CHECK ile bir alana girilebilecek deðerleri sýnýrlayabiliriz. 
• Örneðin; yaþ sütuna negatif sayý girilmesinin engellenmesi gibi. 
• DEFAULT kýsýtlamasý ile de veri girisi sýrasýnda boþ býrakýlan 
kýsýmlara null girilmesi yerine belirledigimiz bir deðerin girilmesi 
saðlanabilir. 
Ornek : þehirler adýnda bir tablo oluþturalým, nüfus için negatif 
